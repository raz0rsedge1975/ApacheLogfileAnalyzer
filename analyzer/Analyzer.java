...
public interface Analyzer {
    ...
    public static String pattern(){
        return "(^(\\d{1,3}\\.){3}\\d{1,3}).+\\[" +     //erste Gruppe, sucht nach IP-Adressen
                ...
                "([A-Z]{3,8}) " +                       //vierte Gruppe, extrahiert die Zugriffsmethode, String muss Großbuchstaben enthalten, zwischen 3 & 4 Zeichen, gibt auch mehr als 4, z.B, REPORT o. PROPFIND
